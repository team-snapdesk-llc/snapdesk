...
class BystanderTicketBox extends Component {
  ...
  render () {
    ...
    if (this.props.ticket.status === 'active') {
      ...
      buttons = (
        <span>
          <Button onClick={() => store.dispatch(ticketActions.updateTicketSocket(this.props.socket, this.props.ticket.messageId, 'pending', (this.props.ticket.mentorId || null)))} type="button" className="btn btn-success">Accept</Button>
      ...
      buttons = (
        <span>
          <Button disabled type="button" className="btn btn-success">Accept (disabled)</Button>
          <Button onClick={() => store.dispatch(ticketActions.updateTicketSocket(this.props.socket, this.props.ticket.messageId, 'active', (this.props.ticket.mentorId || null)))} type="button" className="btn btn-warning">Cancel</Button>
       </span>
        )
    }
